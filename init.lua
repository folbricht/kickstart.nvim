...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>do', vim.diagnostic.setloclist, { desc = '[D]iagnostic - [O]pen quickfix list' })
...
vim.keymap.set('n', '<C-e>', ':BufferLineCycleNext<CR>', { desc = 'Navigate to next buffer', silent = true })
vim.keymap.set('n', '<C-n>', ':BufferLineCyclePrev<CR>', { desc = 'Navigate to previous buffer', silent = true })
...
-- Format *.go imports on save as per https://github.com/golang/tools/blob/master/gopls/doc/vim.md#neovim-imports
...
require('lazy').setup({
  ...
  -- Show buffers as tabs at the top
  {
  ...
  -- Telescope file browser for fuzzy search in the workspace
  {
        ...
        textobjects = {
          ...
          move = {
            ...
            goto_next_start = {
              ...
              ['<A-j>'] = { query = '@function.outer', desc = 'Next method/function def start' },
              [']c'] = { query = '@class.outer', desc = 'Next class start' },
              [']i'] = { query = '@conditional.outer', desc = 'Next conditional start' },
              [']l'] = { query = '@loop.outer', desc = 'Next loop start' },
              [']s'] = { query = '@scope', query_group = 'locals', desc = 'Next scope' },
              [']z'] = { query = '@fold', query_group = 'folds', desc = 'Next fold' },
              ['<A-l>'] = { query = '@parameter.inner', desc = 'Next parameter start' },
            },
            goto_next_end = {
              [']F'] = { query = '@call.outer', desc = 'Next function call end' },
              ['<A-J>'] = { query = '@function.outer', desc = 'Next method/function def end' },
              -- [']M'] = { query = '@function.outer', desc = 'Next method/function def end' },
              [']C'] = { query = '@class.outer', desc = 'Next class end' },
              [']I'] = { query = '@conditional.outer', desc = 'Next conditional end' },
              [']L'] = { query = '@loop.outer', desc = 'Next loop end' },
              ['<A-L>'] = { query = '@parameter.inner', desc = 'Next parameter' },
              -- [']A'] = { query = '@parameter.inner', desc = 'Next parameter' },
            },
            goto_previous_start = {
              ['[f'] = { query = '@call.outer', desc = 'Prev function call start' },
              ['<A-k>'] = { query = '@function.outer', desc = 'Prev method/function def start' },
              ['[c'] = { query = '@class.outer', desc = 'Prev class start' },
              ['[i'] = { query = '@conditional.outer', desc = 'Prev conditional start' },
              ['[l'] = { query = '@loop.outer', desc = 'Prev loop start' },
              ['<A-h>'] = { query = '@parameter.inner', desc = 'Prev parameter start' },
            },
            goto_previous_end = {
              ['[F'] = { query = '@call.outer', desc = 'Prev function call end' },
              ['<A-K>'] = { query = '@function.outer', desc = 'Prev method/function def end' },
              -- ['[M'] = { query = '@function.outer', desc = 'Prev method/function def end' },
              ['[C'] = { query = '@class.outer', desc = 'Prev class end' },
              ['[I'] = { query = '@conditional.outer', desc = 'Prev conditional end' },
              ['[L'] = { query = '@loop.outer', desc = 'Prev loop end' },
              ['<A-H>'] = { query = '@parameter.inner', desc = 'Prev parameter end' },
